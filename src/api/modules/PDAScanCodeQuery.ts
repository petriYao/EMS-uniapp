...
export function PDA_GetBarcodeData(Dannumber, Gxh) {
	...
	let data = {
		"data": {
			...
			"FieldKeys": "FBillStatus,F_CLoseRowState,F_SCDNumber,FBillNo,FWORKSHOPID,F_Number,F_Name,F_Model,F_LJName,F_GXHNo,F_GX,F_Qty,F_WWGQty,F_ZCQty,FID,FDocumentStatus,F_GXNumber,FRouteId,FSCType,FSCGDEntry_FEntryID,F_BZPrice,F_GJBX,F_Price,F_QADV_Amount,F_QADV_Amount1,F_SCQty,F_Dept,F_GXHNo,F_Quantity,F_FBGX,F_JJGX,F_TOGXNo,F_WGQty,F_ZDJJ,FMONumber,FMOEntrySeq,F_SET,F_GYLXVersion,F_Remark,F_Orderid,F_SourceBillType,F_SourceBillNo,FMOEntrySeq1",
			"FilterString": [{
					"Left": "(",
					"FieldName": "FBillNo",
					"Compare": "=",
